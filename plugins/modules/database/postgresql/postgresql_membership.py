...
- "Common use case:"
- 1) add a new group (groups) by M(community.general.postgresql_user) module with I(role_attr_flags=NOLOGIN- 2) grant them desired privileges by M(community.general.postgresql_privs) module
