  ...
  destination_hostgroup:
    description:
      - Route matched queries to this hostgroup. This happens unless there is a
        ...
        I(transaction_persistent) set to C(True) (see M(community.general.proxysql_mysql_users)  cache_ttl:
    description:
...
# single batch using the M(community.general.proxysql_manage_config) module# credentials to connect to the proxysql admin interface.
