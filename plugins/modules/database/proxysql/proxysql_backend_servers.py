...
# runtime in a single batch using the M(community.general.proxysql_manage_config) module# uses supplied credentials to connect to the proxysql admin interface.
