...
DOCUMENTATION = '''
    ...
    - Try to reuse M(community.general.etcd3) options for connection parameters, but add support for some C(ETCDCTL_*    - See U(https://github.com/etcd-io/etcd/tree/master/Documentation/op-guide) for etcd overview.
