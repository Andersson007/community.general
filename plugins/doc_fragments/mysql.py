...
notes:
   - Requires the PyMySQL (Python 2.7 and Python 3.X) or MySQL-python (Python 2.X) package on the remote host.
     The Python package may be installed with apt-get install python-pymysql (Ubuntu; see M(community.general.apt)     yum install python2-PyMySQL (RHEL/CentOS/Fedora; see M(community.general.yum)     for newer versions of Fedora; see M(community.general.dnf).
